            ...
            <div className="absolute right-0 top-4 mt-2 w-48 bg-white rounded-md shadow-md z-10 border border-gray-300 overflow-hidden">
              {loggedIn ? (
                <>
                  ...
                  <Link
                    to="/plans"
                    className="flex items-center justify-center gap-2 text-blue-600 cursor-pointer mx-4 mb-4 mt-2 px-3 py-1.5 text-sm font-medium rounded-full border border-gray-300 hover:border-blue-500 hover:text-blue-700  focus-visible:border-blue-600 focus-visible:ring-1 focus-visible:ring-blue-100 transition-all duration-150 bg-transparent focus:outline-none"
                  >
                    Get more storage
                  </Link>
                </>
