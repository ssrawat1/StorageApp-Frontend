...
export default function ErrorModal({ errorMessage, onDismiss, onRetry = null, isVisible }) {
        ...
        >
          ...
          <div className="flex items-start justify-between mb-4 gap-3">
            <div className="flex items-start gap-3 sm:gap-4 flex-1">
              ...
              {/* Title */}
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 pt-0.5">{title}</h1>
            </div>

            {/* Close Button */}
            <button
              onClick={onDismiss}
              className="text-gray-400 cursor-pointer hover:text-gray-600 transition-colors flex-shrink-0 p-1"
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-4">
            {onRetry && (
              <button
                onClick={onRetry}
                className=" cursor-pointer flex-1 inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
              >
            ...
            <button
              ...
              className="cursor-pointer flex-1 inline-flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg border border-red-200 bg-white hover:bg-red-50 text-gray-700 text-xs sm:text-sm font-semibold transition-all duration-200"
            >
              <RotateCcw className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              <span>Refresh</span>
            </button>
